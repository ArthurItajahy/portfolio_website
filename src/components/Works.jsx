      ...
      >
        ...
        >
          <img 
            src={image}
            alt={name}
            className="w-full h-full obeject-cover rounded-2xl"
          />
    ...
    <>
        ...
        <div className="w-full flex">
          ...
          >
            ...
            demos in it. It reflexts my ability to solve complex problems,
            work with differenct technologies, and manage projects effectively.
